# spf13-vim : Steve Francia's Vim Distribution : fork maintained by aymanim
...
```bash
   ...
   $ curl https://raw.githubusercontent.com/aymanim/spf13-vim/3.0/bootstrap.sh -L > spf13-vim.sh && sh spf13-vim.sh
